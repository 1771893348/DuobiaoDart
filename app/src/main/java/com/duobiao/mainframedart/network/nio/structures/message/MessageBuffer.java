...
public final class MessageBuffer {
    ...
    //----------------------------------------------------------------------------------------
    public static void init(int capacity_small, int capacity_middle, int capacity_large, int size_small, int size_middle, int size_large, int max_temporary_cache_size) {
