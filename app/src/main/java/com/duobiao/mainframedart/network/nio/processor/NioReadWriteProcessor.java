package com.duobiao.mainframedart.network.nio.processor;


import android.util.Log;

import com.duobiao.mainframedart.network.nio.NioConnectListener;
...
public final class NioReadWriteProcessor {
    ...
    public void onSocketExit(int exit_code) {
        Log.d(TAG , "onSocketExit mSocketId " + mSocketId + " exit_code " + exit_code);
